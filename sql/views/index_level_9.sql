...
CREATE NONCLUSTERED INDEX IDX_vRegularOrderAccess_WebComAccess ON Access.vRegularOrderAccess (WebUserID, CommissionID, Access);
CREATE NONCLUSTERED INDEX IDX_vRegularOrderAccess_WebOrderAccess ON Access.vRegularOrderAccess (WebUserID, OrderID, Access);
...
CREATE NONCLUSTERED INDEX IDX_vFolderAccess_WebComAccess ON Access.vFolderAccess (WebUserID, CommissionID, Access);
CREATE NONCLUSTERED INDEX IDX_vFolderAccess_WebFolderAccess ON Access.vFolderAccess (WebUserID, FolderName, Access);
...
CREATE NONCLUSTERED INDEX IDX_vSharedFolderAccess_WebComAccess ON Access.vSharedFolderAccess (WebUserID, CommissionID, Access);
CREATE NONCLUSTERED INDEX IDX_vSharedFolderAccess_WebSharedFolderAccess ON Access.vFolderAccess (WebUserID, FolderName, Access);
...
CREATE NONCLUSTERED INDEX IDX_vSharedRegularOrderAccess_WebComAccess ON Access.vSharedRegularOrderAccess (WebUserID, CommissionID, Access);
CREATE NONCLUSTERED INDEX IDX_vSharedRegularOrderAccess_WebOrderAccess ON Access.vSharedRegularOrderAccess (WebUserID, OrderID, Access);
...
CREATE NONCLUSTERED INDEX IDX_vRegularSharedOrderAccess_WebComAccess ON Access.vRegularSharedOrderAccess (WebUserID, CommissionID, Access);
CREATE NONCLUSTERED INDEX IDX_vRegularSharedOrderAccess_WebOrderAccess ON Access.vRegularSharedOrderAccess (WebUserID, OrderID, Access);
...
CREATE NONCLUSTERED INDEX IDX_vSharedCommissionAccess_WebComAccess ON Access.vSharedCommissionAccess (WebUserID, CommissionID, Access);
CREATE NONCLUSTERED INDEX IDX_vSharedCommissionAccess_WebOrderAccess ON Access.vSharedCommissionAccess (WebUserID, OrderID, Access);
