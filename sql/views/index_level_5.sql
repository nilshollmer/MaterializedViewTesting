...
CREATE UNIQUE CLUSTERED INDEX IDX_vRegularOrderAccess ON Access.vRegularOrderAccess (WebUserID, CommissionID, OrderID, OrderDate, Access);
...
CREATE UNIQUE CLUSTERED INDEX IDX_vFolderAccess ON Access.vFolderAccess (WebUserID, CommissionID, FolderID, FolderName, OrderID, OrderDate, Access);
...
CREATE UNIQUE CLUSTERED INDEX IDX_vSharedFolderAccess ON Access.vSharedFolderAccess (WebUserID, CommissionID, FolderID, FolderName, OrderID, OrderDate, Access);
...
CREATE UNIQUE CLUSTERED INDEX IDX_vSharedRegularOrderAccess ON Access.vSharedRegularOrderAccess (WebUserID, CommissionID, OrderID, OrderDate, Access);
...
CREATE UNIQUE CLUSTERED INDEX IDX_vRegularSharedOrderAccess ON Access.vRegularSharedOrderAccess (WebUserID, CommissionID, OrderID, OrderDate, Access);
...
CREATE UNIQUE CLUSTERED INDEX IDX_vSharedCommissionAccess ON Access.vSharedCommissionAccess (WebUserID, CommissionID, OrderID, OrderDate, Access);
